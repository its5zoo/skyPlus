            ...
            >
                {hourly.map((item, idx) => (
                    <motion.div
                        ...
                        className={`flex-shrink-0 flex flex-col items-center gap-2 glass rounded-2xl px-3 sm:px-4 py-3 sm:py-4 
              cursor-default transition-colors duration-200 hover:bg-slate-900/5 dark:hover:bg-white/15 min-w-[64px] sm:min-w-[70px]
